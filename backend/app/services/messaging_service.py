...
class MessagingService:
    ...
    def publish_upload_event(self, request_id: str, document_id: str, validation_results: dict):
        """
        ...
        if not self.producer:
            ...
            logger.info(f"Mock Published to {self.topic}: req={request_id}, doc={document_id}")
            return
